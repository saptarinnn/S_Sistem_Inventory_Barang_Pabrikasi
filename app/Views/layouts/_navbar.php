                ...
                <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2" aria-labelledby="hs-dropdown-with-header">
                        <div class="px-5 py-3 -m-2 bg-gray-100 rounded-t-lg">
                            ...
                            <p class="font-semibold text-gray-800"><?= ucwords(session('nama_lengkap')) ?></p>
                        </div>
                        <div class="py-2 mt-2 first:pt-0 last:pb-0">
                            <a class="flex items-center font-semibold gap-x-3.5 py-2 px-3 rounded-lg text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500" href="<?= site_url('change-password') ?>">
