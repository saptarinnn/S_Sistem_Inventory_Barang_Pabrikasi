...
<div class="w-full py-5 mx-auto">
    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7">
        ...
        <form method="post" action="<?= site_url('pemasok/save') ?>">
            <?= csrf_field(); ?>
            <!-- Nama Pemasok -->
            <div class="mb-4">
                <label for="nama" class="block mb-2 font-bold">Nama Pemasok</label>
                <input type="text" id="nama" name="nama" class="block w-full px-3 py-2 font-bold border border-gray-200 rounded-lg" placeholder="Input nama pemasok" required>
                <!-- Error -->
