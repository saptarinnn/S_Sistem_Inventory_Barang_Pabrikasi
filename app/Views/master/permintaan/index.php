...
<div class="w-full py-5 mx-auto">
    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7">
        <div class="flex justify-end">
            <a href="<?= site_url('permintaan/create') ?>" class="px-3 py-1 pb-2 font-semibold text-white transition duration-300 rounded-md bg-slate-500 hover:bg-slate-600">Tambah Data</a>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-semibold text-slate-900">
                                            ...
                                            <?php if ($permintaan->status_permintaan == 'selesai') : ?>
                                                <span class="text-sm font-bold text-green-500">Permintaan Diterima</span>
                                            <?php endif; ?>
                                            <?php if ($permintaan->status_permintaan == 'gagal') : ?>
                                                <span class="text-sm font-bold text-red-500">Permintaan Ditolak</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if ($permintaan->status_permintaan == 'kirim') : ?>
