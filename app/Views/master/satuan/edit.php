...
<div class="w-full py-5 mx-auto">
    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7">
        ...
        <form method="post" action="<?= site_url('satuan/' . $satuan->id . '/update') ?>">
            <?= csrf_field(); ?>
            <!-- Nama Satuan -->
            <div class="mb-4">
                <label for="nama_satuan" class="block mb-2 font-bold">Nama Satuan</label>
                <input type="text" id="nama_satuan" name="nama_satuan" class="block w-full px-3 py-2 font-bold border border-gray-200 rounded-lg" placeholder="Input nama satuan" required value="<?= $satuan->nama_satuan ?>">
                <!-- Error -->
