...
<div class="w-full py-5 mx-auto">
    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7">
        <div class="flex justify-end">
            <a href="<?= site_url('satuan/create') ?>" class="px-3 py-1 pb-2 font-semibold text-white transition duration-300 rounded-md bg-slate-500 hover:bg-slate-600">Tambah Data</a>
        </div>
