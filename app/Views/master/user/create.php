    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7">
        ...
        <form method="post" action="<?= site_url('users/save') ?>">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="fullname" name="fullname" class="block w-full px-3 py-2 font-bold border border-gray-200 rounded-lg" placeholder="Input fullname" required>
                <!-- Error -->
